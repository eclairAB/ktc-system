...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('/get/print/aging',[QueriesController::class,"prntAging"]);
    Route::post('/get/print/daily_in',[QueriesController::class,"prntDailyIn"]);
    Route::post('/get/print/daily_out',[QueriesController::class,"prntDailyOut"]);
