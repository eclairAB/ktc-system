...
class ExcelController extends Controller
{
    ...
    public function containerAging($type,$sizeType,$client,$class,$date_in_from,$date_in_to,$date_out_from,$date_out_to,$option)
    {
        $now = Carbon::now()->format('Y-m-d');
        return Excel::download(new ContainerAging($type,$sizeType,$client,$class,$date_in_from,$date_in_to,$date_out_from,$date_out_to,$option), 'Container_Aging_'.$now.'.xlsx');
    }
}
