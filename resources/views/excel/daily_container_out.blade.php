<table>
        ...
        <tr>
         <td style="width:50px; text-align:left;">{{ $item->container_no }}</td>
          ...
          <td style="width:50px; text-align:left;">{{ Carbon\Carbon::parse($item->releasing->inspected_date)->format('Y-m-d') }}</td>
          ...
          <td style="width:50px; text-align:left;">{{ Carbon\Carbon::parse($item->releasing->inspected_date)->format('Y-m-d h:i') }}</td>
        </tr>
      @endforeach
</table>