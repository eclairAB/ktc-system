<table>
        ...
        <tr>
          ...
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ Carbon\Carbon::parse($item->receiving->inspected_date)->format('d/m/Y') }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ Carbon\Carbon::parse($item->receiving->inspected_date)->format('H:i') }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->receiving->plate_no }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->receiving->hauler }}</td>
          ...
          <td style="width:50px; font-size: 10px; font-family: Arial;">{{ Carbon\Carbon::parse($item->receiving->inspected_date)->format('d/m/Y H:i') }}</td>
        </tr>
      @endforeach
</table>