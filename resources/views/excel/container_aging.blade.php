<table>
        ...
        <tr>
          ...
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->client->code??'' }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->containerClass->class_code??'' }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ is_null($item->receiving)?'':Carbon\Carbon::parse($item->receiving->inspected_date)->format('d/m/Y') }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->receiving->consignee??'' }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ is_null($item->releasing)?'':Carbon\Carbon::parse($item->releasing->inspected_date)->format('d/m/Y') }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->releasing->consignee??'' }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->releasing->booking_no??'' }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->releasing->seal_no??'' }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->total_no_days }}</td>
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">
          ...
          <td style="width:50px; text-align:left; font-size: 10px; font-family: Arial;">{{ $item->receiving->remarks??'' }}</td>
        </tr>
      @endforeach
</table>
<table>
