                ...
                <div class="panel panel-bordered">
                    <div id="damageForm">
                        ...
                        <div class="panel-footer" style="display: flex; justify-content: flex-end;">
                            <button type="submit" :disabled="customload" class="btn btn-primary save buttonload" @click="form.id ? updateDamage() : saveDamage()" style="display: flex; align-items:center;">
    ...
    <script type="text/javascript">
        ...
        methods:{
          async saveDamage () {
            ...
            await axios.post('/admin/create/container/damages', this.form).then(data => {
          ...
          async updateDamage () {
            ...
            let browseUrl = `${currentUrl}/admin/container-damages`
            this.$set(this.form, 'code', this.form.code.toUpperCase())
            this.$set(this.form, 'name', this.form.name.toUpperCase())
            await axios.post('/admin/update/container/damages', this.form).then(data => {
              this.customload = false
              $('#savingDialog').modal('hide');
              this.errors = {}
          ...
          async getdata () {
            ...
            if (checkedit === 'edit') {
              ...
              await axios.get(`/admin/get/container/damages/byId/${payload.id}`).then(data => {
                this.form = data.data
              }).catch(error => {
