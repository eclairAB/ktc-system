                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions" style="display: flex; justify-content: flex-end;">
                                            <div id="printButtonRelease"><button class="btn btn-success" @click="printData({{ $data->{$data->getKeyName()} }})"><i class="voyager-file-text"></i> Print</button></div>
                                            @foreach($actions as $action)
                                                @if (!method_exists($action, 'massAction'))
