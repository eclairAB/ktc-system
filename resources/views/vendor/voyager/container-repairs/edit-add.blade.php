                ...
                <div class="panel panel-bordered">
                    <div id="repairForm">
                        ...
                        <div class="panel-footer" style="display: flex; justify-content: flex-end;">
                            <button type="submit" :disabled="customload" class="btn btn-primary save buttonload" @click="form.id ? updateRepair() : saveRepair()" style="display: flex; align-items:center;">
    ...
    <script type="text/javascript">
        ...
        methods:{
          async saveRepair () {
            ...
            await axios.post('/admin/create/container/repairs', this.form).then(data => {
          ...
          async updateRepair () {
            ...
            let browseUrl = `${currentUrl}/admin/container-repairs`
            this.$set(this.form, 'code', this.form.code.toUpperCase())
            this.$set(this.form, 'name', this.form.name.toUpperCase())
            await axios.post('/admin/update/container/repairs', this.form).then(data => {
              this.customload = false
              $('#savingDialog').modal('hide');
              this.errors = {}
          ...
          async getdata () {
            ...
            if (checkedit === 'edit') {
              ...
              await axios.get(`/admin/get/container/repairs/byId/${payload.id}`).then(data => {
                this.form = data.data
              }).catch(error => {
