                ...
                <div class="panel panel-bordered">
                    <div id="yardLocationForm">
                        ...
                        <div class="panel-footer" style="display: flex; justify-content: flex-end;">
                            <button type="submit" :disabled="customload" class="btn btn-primary save buttonload" @click="form.id ? updateYard() : saveYard()" style="display: flex; align-items:center;">
