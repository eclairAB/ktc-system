                ...
                <div class="panel panel-bordered">
                    <div id="ContainerClassForm">
                        ...
                        <div class="panel-footer" style="display: flex; justify-content: flex-end;">
                            <button type="submit" :disabled="customload" class="btn btn-primary save buttonload" @click="form.id ? updateClass() : saveClass()" style="display: flex; align-items:center;">
