                ...
                <div class="panel panel-bordered">
                    <div id="staffForm">
                        <div class="panel-body">
                            <div class="row" style="padding: 0px 10px;">
                              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                <input type="text" name="id_no" id="id_no" v-model="form.id_no" class="form-control" :class="errors.id_no ? 'isError' : ''" style="height: 37px; text-transform: uppercase;">
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                <input type="text" name="firstname" id="firstname" v-model="form.firstname" class="form-control" :class="errors.firstname ? 'isError' : ''" style="height: 37px; text-transform: uppercase;">
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                <input type="text" name="lastname" id="lastname" v-model="form.lastname" class="form-control" :class="errors.lastname ? 'isError' : ''" style="height: 37px; text-transform: uppercase;">
                        ...
                        <div class="panel-footer" style="display: flex; justify-content: flex-end;">
                            <button type="submit" :disabled="customload === true" class="btn btn-primary save buttonload" @click="form.id ? updateChecker() : saveChecker()" style="display: flex; align-items:center;">
        ...
        methods:{
          ...
          async getdata () {
            ...
            if (checkedit === 'edit') {
              ...
              await axios.get(`/admin/get/checker/byId/${payload.id}`).then(data => {
                this.form = data.data
              }).catch(error => {
